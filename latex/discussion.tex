...
\section*{Discussion}
  ...
  OpenCV is a BSD-licensed open-source library focused on computer vision, with
  ...
  through ``rough consensus and working code'' \citep{rfc2418}.  There are
  typically two ways to propose new ideas: through discussion on the mailing
  ...
  \begin{enumerate*}
    \item Obtain test coverage of more than 95\%.
